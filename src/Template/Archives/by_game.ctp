...
<div class="row">
    <div class="col-md-10 col-centered">
            ...
            <?php if ($currentGame != $mpic->mark->hunt->game->name): ?>
                <h2><?= $mpic->mark->hunt->game->name; ?></h2>
            <?php $currentGame = $mpic->mark->hunt->game->name; ?>
            <?php endif; ?>
            <div class="text-center" style="display: inline-block">
                <div class="thumb-container">
                   <div class="thumb-pic" style="background-image: url('../../pictures/<?= $mpic->guid ?>_thumb.png');">
                       <a href="../../pictures/<?= $mpic->guid ?>.png" class="fancybox" data-title-id="title-<?= $i ?>" rel="<?= $mpic->mark->hunt->game->name; ?>"><img src="../../img/blank.png" class="thumb-blank"></a>
